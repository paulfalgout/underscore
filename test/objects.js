(function() {
  ...
  test('isMatch', function() {
    ...
    deepEqual(_.map([null, undefined, 5, {}], _.partial(_.isMatch, _, oCon)), [false, false, false, true], 'doesnt falsely match constructor on undefined/null');
  });
  ...
  test('matcher', function() {
    ...
    deepEqual(_.map([null, undefined, 5, {}], oCon), [false, false, false, true], 'doesnt falsely match constructor on undefined/null');
  });
